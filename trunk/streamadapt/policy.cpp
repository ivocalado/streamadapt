...
namespace AdaptationPolicy
{
  ...
  const stream::video_codec_type& stream::
  video_codec () const
  {
    return this->video_codec_.get ();
  }

  stream::video_codec_type& stream::
  video_codec ()
  {
    return this->video_codec_.get ();
  }
  ...
  const stream::audio_codec_type& stream::
  audio_codec () const
  {
    return this->audio_codec_.get ();
  }

  stream::audio_codec_type& stream::
  audio_codec ()
  {
    return this->audio_codec_.get ();
  }
  ...
  {
    this->audio_codec_.set (x);
  }

  void stream::
  audio_codec (::std::auto_ptr< audio_codec_type > x)
  {
    this->audio_codec_.set (x);
  }
  ...
  const stream::property_sequence& stream::
  property () const
  {
    return this->property_;
  }

  stream::property_sequence& stream::
  property ()
  {
    return this->property_;
  }
...
namespace AdaptationPolicy
{
  ...
  stream::
  stream (const video_codec_type& video_codec,
          const audio_codec_type& audio_codec,
          const enable_adaptation_type& enable_adaptation)
  : ::xml_schema::type (),
    video_codec_ (video_codec, ::xml_schema::flags (), this),
    audio_codec_ (audio_codec, ::xml_schema::flags (), this),
    enable_adaptation_ (enable_adaptation, ::xml_schema::flags (), this),
  ...
  : ::xml_schema::type (x, f, c),
    ...
    audio_codec_ (x.audio_codec_, f, this),
    enable_adaptation_ (x.enable_adaptation_, f, this),
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_elements (); p.next_element ())
    {
      ...
      // audio-codec
      //
      if (n.name () == "audio-codec" && n.namespace_ ().empty ())
      {
        ::std::auto_ptr< audio_codec_type > r (
          audio_codec_traits::create (i, f, this));

        if (!audio_codec_.present ())
        {
          this->audio_codec_.set (r);
          continue;
        }
      }
